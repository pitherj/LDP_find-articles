...
│   ├── LDP-MODULES_ALL_2020-2022.xlsx             # [PRIVATE, git-ignored] Full LDP course roster
│   ├── Training_event_data.xlsx                  # [PRIVATE, git-ignored] Course ID → year/title lookup
...
- **Path**: `raw_data/LDP-MODULES_ALL_2020-2022.xlsx`
- **Type**: Input — private
...
- **Path**: `raw_data/Training_event_data.xlsx`
- **Type**: Input — private
- **Source**: LDP administrative records (internal)
- **Access**: Restricted to Jason Pither and Diane Srivastava
...
|---|---|---|---|
| `raw_data/LDP-MODULES_ALL_2020-2022.xlsx` | Yes | Yes | Manual (LDP admin records) |
| `raw_data/Training_event_data.xlsx` | Yes | Yes | Manual (LDP admin records) |
