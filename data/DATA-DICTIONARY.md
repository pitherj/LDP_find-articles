...
Comparator author publications after the same three filtering layers applied to the LDP publications. All columns from `processed_data/comparator_author_publications.csv` are retained, plus `is_paratext` and `type_crossref`.
